...
const page = async ({ searchParams }: Props) => {
  ...
  return (
    <Container className="flex items-center flex-col md:flex-row px-4 xl:px-0 py-20 ">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-2">
        ...
        <p>
          ...
          <FormattedPrice
            ...
            className="text-base font-semibold bg-designColor text-white underline underline-offset-2"
          />{" "}
          from this product.
        </p>
